package io.github.mattpvaughn.compass.util
...
fun String.toColorInt(): Int {
    ...
    if (tempString.length == 4) {
        tempString = "#" + tempString[1] + tempString[1] + tempString[2] + tempString[2] + tempString[3] + tempString[3];
    }
    return Color.parseColor(tempString);
}